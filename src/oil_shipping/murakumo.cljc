...
(defn collection
  [name]
  (str "com.etzhayyim.oil-shipping." name))

(def cell-specs {
  :getcargo {:legacy-cell "com-etzhayyim-apps-oilShipping-routing-getCargo"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "getcargo")]
     :required-gates common-gates
     :trigger "manifest cell getcargo"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :listcargoes {:legacy-cell "com-etzhayyim-apps-oilShipping-routing-listCargoes"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "listcargoes")]
     :required-gates common-gates
     :trigger "manifest cell listcargoes"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :getrouteexposure {:legacy-cell "com-etzhayyim-apps-oilShipping-routing-getRouteExposure"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "getrouteexposure")]
     :required-gates common-gates
     :trigger "manifest cell getrouteexposure"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :listchokepoints {:legacy-cell "com-etzhayyim-apps-oilShipping-routing-listChokepoints"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "listchokepoints")]
     :required-gates common-gates
     :trigger "manifest cell listchokepoints"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :health {:legacy-cell "com-etzhayyim-apps-oilShipping-health"
     :phase :event
     :murakumo-node "reuben"
  ...
  :cargo {:legacy-cell "com-etzhayyim-apps-oilShipping-cargo"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :route {:legacy-cell "com-etzhayyim-apps-oilShipping-route"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "route")]
     :required-gates common-gates
     :trigger "manifest cell route"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :ststransfer {:legacy-cell "com-etzhayyim-apps-oilShipping-stsTransfer"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "ststransfer")]
     :required-gates common-gates
     :trigger "manifest cell ststransfer"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
